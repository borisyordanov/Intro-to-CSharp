...
class BinaryToHexadecimalConverter
{
    static void Main(string[] args)
    {
        ...
        string reversedBinaryRepresentation = null;
        for (int i = 0; i < clearBinaryRepresentation.Length; i++)
        {
            reversedBinaryRepresentation = clearBinaryRepresentation[i] + reversedBinaryRepresentation;
        }
